package com.superion.infusionsystem.util;
        ...
        public TableRowView(Context context, TableRow tableRow, int position) {  
            ...
            for (int i = 0; i < tableRow.getSize(); i++) {//逐个格单元添加到行  
                ...
                if (tableCell.type == TableCell.STRING) {//如果格单元是文本内容  
                    ...
                    if(position == 0){
                    	textCell.setBackgroundColor(Color.rgb(216, 216, 216));
                    }else if(position%2 == 0){
                    	textCell.setBackgroundColor(Color.WHITE);//背景白色
                    }else{
                    	textCell.setBackgroundColor(Color.rgb(209, 234, 234));
                    }
                    
                    if(position == -1){
                    	textCell.setBackgroundColor(Color.rgb(196, 196, 193));
                    }
