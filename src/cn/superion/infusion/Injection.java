		...
		serialText.setOnFocusChangeListener(new OnFocusChangeListener(){
			...
			public void onFocusChange(View v, boolean hasFocus) {
				if(!hasFocus){
					...
					TableAdapter tableAdapter = new TableAdapter(Injection.this, table);  
		...
		identifierText.setOnFocusChangeListener(new OnFocusChangeListener(){
			...
			public void onFocusChange(View v, boolean hasFocus) {
				if(!hasFocus){
					...
					if(patient == null){
						new AlertDialog.Builder(Injection.this)
						.setTitle("错误提示")
					...
					infusion.puncture(infusions.get(0).getAutoId(), labelCode);
				}
			}
        });
    }  
